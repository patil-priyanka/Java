...
public class BLRandom {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
        	System.out.printf("%2d ",   BLRandom.uniform(100));
        	System.out.printf("%8.5f ", BLRandom.uniform(10.0, 99.0));
        	System.out.printf("%5b ",   BLRandom.bernoulli(0.5));
        	System.out.printf("%7.5f ", BLRandom.gaussian(9.0, 0.2));
        	System.out.printf("%1d ",   BLRandom.discrete(probabilities));
        	System.out.printf("%1d ",   BLRandom.discrete(frequencies));
        	System.out.printf("%11d ",  BLRandom.uniform(100000000000L));
        	BLRandom.shuffle(a);
            for (String s : a)
            	System.out.print(s);
            System.out.println();
